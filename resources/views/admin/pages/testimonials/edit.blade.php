        ...
        <form action="{{route('admin.testimonials.update', $data->id)}}" method="post" enctype="multipart/form-data">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="qoute" placeholder="please type qoute" name="qoute" value="{{$data->qoute}}">
                    <div class="has-error">
                    <span class="help-block">
                        {{$errors->first('qoute')}}
                    </span>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" placeholder="please type name" name="name" value="{{$data->name}}">
                    <div class="has-error">
                    <span class="help-block">
                        {{$errors->first('name')}}
                    </span>
